package questions;// This program plays the question guessing game with a user.  It reads the
...
public class QuestionMain {
    public static final String QUESTION_FILE = "20Questions/question.txt";
